...
export default function EditorPannel({
  selectedElement,
  onUpdate,
  onClose,
}: EditorPannelProps) {
      ...
      <div className="space-y-4 text-black">
        <div>
          ...
          <textarea
            ...
            className="w-full text-sm p-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-[#22D3EE] outline-none min-h-20"
          />
        </div>
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">
          ...
          <input
            ...
            className="w-full text-sm p-2 border border-gray-400 rounded-md focus:ring-2 focus:ring-[#22D3EE] outline-none"
          />
        </div>
